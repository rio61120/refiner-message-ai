...
import { MAX_MESSAGE_LENGTH, MAX_TARGET_LANGUAGE_LENGTH, MIN_MESSAGE_LENGTH } from "@app/refine/refine.constants";
...
export class RefineRequestDto {
  ...
  @ValidateIf((payload: RefineRequestDto) => payload.action === RefineAction.Translate)
  @IsString()
  @MinLength(2)
