import { AiPromptInput } from "@app/ai/prompts/ai-prompt.service";
...
const ACTION_INSTRUCTIONS: Record<RefinePromptAction, string> = {
  grammar: "Fix spelling, grammar, punctuation, and awkward phrasing while preserving the original language and meaning.",
  translate: "Translate the message into the requested target language. Preserve URLs, IDs, mentions, and product names exactly."
};
